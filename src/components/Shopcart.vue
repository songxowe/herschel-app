<template>
    ...
    <div class="concent" >
        ...
        <div id="cartTable">
            ...
            <tr class="item-list">
                <div class="bundle  bundle-last "  style="width:1000px">
                    <div class="bundle-hd">
                        <div class="bd-promos">
                ...
                <form class="theme-signin" name="loginform" action="" method="post">
                    ...
                    <div class="theme-signin-left">
                        ...
                        <li class="theme-options">
                            ...
                            <ul>
                                <li class="sku-line selected">12#川南玛瑙
                                    <i></i>
                                </li>
                                <li class="sku-line">10#蜜橘色+17#樱花粉
                                    <i></i>
                                </li>
                            </ul>
                        </li>
                        <li class="theme-options">
                            ...
                            <ul>
                                <li class="sku-line selected">包装：裸装
                                    <i></i>
                                </li>
                                <li class="sku-line">两支手袋装（送彩带）
                                    <i></i>
                                </li>
                            </ul>
                        </li>
